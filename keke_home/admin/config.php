...
function editinfo()
{
	...
	{
    $sNow = date("Y-m-d");
    $aSystemKK = $db->get_one("SELECT * FROM `h_system_total` where `record_time` = '{$sNow}'");
?>
<div style="font-size: 25px;font-weight: 800;"><label for="totalsum">平台总KK:</label><span style="color:blue;"><?php echo floatval($aSystemKK['total_money']);?></span></div><br>
<div style="font-size: 25px;font-weight: 800;"><label for="daysum">平台今日所产KK:</label><span style="color:blue;"><?php echo floatval($aSystemKK['day_money']);?></span></div><br>
